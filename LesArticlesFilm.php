...
<body style="font-family:Marmelad; font-size: 18px;background-image:url('test/wallpapertest2.jpg');background-size: cover;
    ...
    <div class='text-center'>
     <?php  echo"<img style='width: 400px;margin-bottom:5px;' class='img img-thumbnail img-responsive'src='test/Serie/".$ligne["Photo"]."'>";?>
      ...
      <?php echo " <a href='index.php?page=unFilm&id=$nodocument' class='btn btn-primary' style='margin-top: 2px;margin-bottom: 2px;'>Présentation</a>";?>
     ...
     <?php 
     $req=$con->prepare("SELECT *,DATE_FORMAT(DATE_ART, '%e %M %Y') AS DATEMODIF FROM article,film WHERE article.NO_DOCUMENT=film.NO_DOCUMENT AND article.NO_DOCUMENT=:film");
